$(document).ready(function () {
  ...
  if ($("#targetVsActualChart").length) {
    var targetVsActualChartCanvas =
      $("#targetVsActualChart").get(0).getContext("2d");
    ...
    var targetVsActualChartOptions = {
      ...
      responsive: true,
      //Boolean - maintain aspect ratio of chart
      maintainAspectRatio: true
    };

    targetVsActualChartOptions.datasetFill = false;

    targetVsActualChart.Bar(targetVsActualChartData,
      targetVsActualChartOptions);
  }

  // household chart
  if ($("#householdsTargetVsActualChart").length) {
    var householdsTargetVsActualChartCanvas =
      $("#householdsTargetVsActualChart").get(0).getContext("2d");
    var householdsTargetVsActualChart =
      new Chart(householdsTargetVsActualChartCanvas);
    ...
    householdsTargetVsActualChart.Bar(householdsTargetVsActualChartData,
      householdsTargetVsActualChartOptions);
  }
  ...
  if($("#beneficiariesByGenderChart").length) {
    var pieChartCanvas =
      $("#beneficiariesByGenderChart").get(0).getContext("2d");
    var pieChart = new Chart(pieChartCanvas);
    var PieData = [
      {
        value: 700,
